...
int validUserAccount(user_command_t* command, char* accountID){
    ...
    char* endptr = NULL;
    int ID = strtol(accountID,&endptr,10);
...
int validDelay(user_command_t* command, char* delay){
    ...
    char* endptr = NULL;
    int op_delay = strtol(delay,&endptr,10);
...
int validOperation(user_command_t* command, char* operation){
    ...
    char* endptr = NULL;
    int op_number = strtol(operation,&endptr,10);
...
int validBalance(char* value){
    ...
    char* endptr = NULL;
    long unsigned int balance = strtol(value,&endptr,10);
...
int validAmount(char* value){
    ...
    char* endptr = NULL;
    long unsigned int amount = strtol(value,&endptr,10);
