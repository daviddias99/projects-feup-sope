...
/**
 * @brief Used to record he request on to the user
 * Logfile.
 * 
...
/**
 * @brief Used to reply he request on to the user
 * Logfile.
 * 
...
/**
 * @brief Get the name of the fifo used  to communicate the response
 * 
 * @return char*        Pointer to the array of chars that contains the path of fifo
 * 
 */
